...
| `SOCRATA_APP_TOKEN` | No | Más cuota en datos.gov.co (header `X-App-Token`): 1 000 peticiones por hora móvil con token (dev.socrata.com, consultado el 5-sep-2026); sin token Socrata no publica el cupo. Necesaria en cuanto la usen varias personas a la vez |
