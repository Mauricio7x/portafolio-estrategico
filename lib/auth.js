/* ============================================================================
   ...
   ----------------------------------------------------------------------------
   Nueve endpoints exigen el MISMO token (`HISTORICO_TOKEN`) y en su día cada
   ...
   agujero, así que la comprobación vive aquí y solo aquí:
     ...
     /api/indice-baja        expone (y reconstruye) la baja de mercado
     /api/resumen            agrega el corpus activo para el panel
     /api/admin/rup          lee y ESCRIBE el RUP del dueño
     /api/admin/experiencia  lee y ESCRIBE sus contratos ya ejecutados
     /api/admin/cobertura-rup audita el histórico contra la whitelist del RUP
     /api/apu/inferir        infiere los ítems del APU y ESCRIBE `apu:*`
