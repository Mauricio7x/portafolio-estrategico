...
async function borrarExperiencia(redis) {
  await redis.del(CLAVES.configExperiencia, CLAVES.configExperienciaTerminos, CLAVES.configExperienciaVersion);
}
...
module.exports = {
  ...
  guardarExperiencia, leerExperiencia, leerTerminos, selloExperiencia, borrarExperiencia,
};
