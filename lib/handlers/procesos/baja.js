...
module.exports = async function handler(req, res) {
  ...
  return res.status(200).json({
    ...
    como_leerlo: "`indice.entidad` es el hash por entidad; dentro de cada registro, `segmentos` trae la "
      ...
      + "`departamento_familia`. El hash `departamento` se construye y se sirve aquí SOLO para consulta "
      + "cruda: ningún consumidor automático lo lee (decisión pendiente del dueño, auditoría 27-ago-2026). "
