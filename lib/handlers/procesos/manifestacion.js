...
const { leerManifestacion, NORMA, PLAZO_MANIFESTACION_HABILES, PLAZO_MINIMO_HABILES, MAX_MANIFESTACIONES_SIN_SORTEO, estadoDeVentana, sigueValiendoLaPena } = require("../../portada.js");
...
module.exports = async function handler(req, res) {
  ...
  for (const f of ventana.abiertos || []) {
    ...
    if (!sigueValiendoLaPena({ estado: est })) continue;   // lo vencido desde que se escribió la ventana se retira (mismo predicado que todos)
