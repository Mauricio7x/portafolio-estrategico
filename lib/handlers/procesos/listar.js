  ...
  const resultados = lista.slice((pagina - 1) * porPagina, (pagina - 1) * porPagina + porPagina)
    ...
    .map((l) => {
      ...
      const salida = {
        ...
        /* Manifestación de interés (selección abreviada de menor cuantía): la
           fecha límite CALCULADA (apertura + 3 días hábiles, D. 1082/2015 art.
           2.2.1.2.1.2.20) con los hábiles que quedan; null cuando la modalidad
           no la exige. La misma regla que la portada y Mis procesos
           (lib/manifestacion). */
