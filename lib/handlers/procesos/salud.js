...
module.exports = async function handler(req, res) {
  ...
  if (lecturaIndice && lecturaIndice.ok === false) {
  ...
  return res.status(200).json({
    ...
    lectura_indice_competencia: lecturaIndice
      ? { ...lecturaIndice, alcance: "solo esta instancia del servidor: otra puede haber leído bien o mal; recargue esta dirección para ver otra" }
      : null,
