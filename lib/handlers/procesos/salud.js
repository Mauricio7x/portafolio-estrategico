...
module.exports = async function handler(req, res) {
  ...
  let meta, metaHist, progresoHist, ttl;
  try {
    ...
    [[meta, metaHist, progresoHist], ttl] = await Promise.all([
      leerVariosJSON(redis, [CLAVES.meta, CLAVES.metaHistorico, CLAVES.progresoHistorico]),
