    ...
    return {
      ...
      cuerpo: {
        ...
        siguiente_paso: "Compruebe que el id del dataset sigue siendo válido en datos.gov.co y que el "
          + "despliegue tiene salida a Internet. Si datos.gov.co limitó las consultas, configure SOCRATA_APP_TOKEN "
          + "(la llave de datos.gov.co): el portal no publica cuántas consultas por hora permite, con llave ni sin ella.",
      },
    };
  }
