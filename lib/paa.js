...
module.exports = {
  ...
  resolverColumnas, fechaISO, fechaPaa, pesos, ventanaDoceMeses, coincideUnspsc,
  crearClientePaa: (opciones = {}) => crearCliente({ baseUrl: BASE(), fetchImpl: opciones.fetchImpl, log: opciones.log }),
};
