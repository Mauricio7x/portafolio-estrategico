/* ════════════════ Accesibilidad operativa de la zona de la obra ════════════════
   ...
   Ibagué son las bases del DUEÑO (`BASE_DUENO`: la suya y la de sus socias,
   que están matriculadas allí; PICS, socia desde el 25-sep-2026, es de
   Sogamoso, y la base sigue siendo la que el dueño fijó). Un
