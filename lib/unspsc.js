...
/* Atajo cómodo: licitación + Set del RUP → veredicto. */
function emparejarLicitacion(lic, setRup) {
  return emparejar(codigosDeLicitacion(lic).codigos, indiceDe(setRup));
}
