...
function validarPerfil(acc, clave, p, opciones = {}) {
  ...
  if (p.experiencia_segmento72_mayores_smmlv != null) {
    ...
    if (!Array.isArray(m) || m.length > 7) acc.error(`${base}.experiencia_segmento72_mayores_smmlv`, "debe ser una lista de hasta 7 valores en salarios mínimos", m);
    else m.forEach((v, i) => numero(acc, `${base}.experiencia_segmento72_mayores_smmlv[${i}]`, v, { min: 0 }));
  }
