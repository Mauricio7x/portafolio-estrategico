...
const CONECTIVIDAD_DE_TELECOM = "conectividad(?=[\\s\\S]{0,40}\\b(?:internet|datos|banda|canal|wifi|red\\s+lan|telecom|fibra|servicio|enlace|proveedor))";
