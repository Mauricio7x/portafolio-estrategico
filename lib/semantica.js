...
const FASE_ANTES_MANIFESTACION_RE = /^(?:presentaci[oó]n\s+de\s+observaciones(?!\s+al\s+informe)|observaciones\s+al\s+proyecto|borrador|proyecto\s+de\s+pliego)/;
const FASE_TRAS_MANIFESTACION_RE = /^(?:presentaci[oó]n\s+de\s+ofertas?|fase\s+de\s+ofertas?|ofertas?\b|recepci[oó]n\s+de\s+ofertas?|selecci[oó]n|(?:en\s+)?evaluaci[oó]n|informe|adjudicaci[oó]n|adjudicad[oa]|celebrad[oa]|(?:en\s+)?ejecuci[oó]n|terminad[oa]|liquidaci[oó]n|liquidad[oa]|(?:declarad[oa]\s+)?desiert[oa])/;
