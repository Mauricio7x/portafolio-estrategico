...
function extraerRupDeTexto(texto) {
  ...
  advertencias.push("El RUP no publica la planta de profesionales: se asume 1 (el factor CT de la capacidad K queda en su mínimo, 20). Si su equipo es mayor, corregilo cargando el RUP desde la pestaña «Mi empresa».");
