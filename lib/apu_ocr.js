...
async function ocrPaginas(paginas, opciones = {}) {
  ...
  for (let i = 0; i < tope; i++) {
    ...
    /* Cada página leída va PRECEDIDA de su marcador `\f<i+1>` (índice dentro
       del LOTE: el servidor no sabe en qué página del PDF empieza la tanda; el
       navegador re-basa con `rebasarMarcadores`). Así una página que falla no
       corre la numeración de las siguientes. */
