...
const SIN_ANTICIPO_RE = /\bno (?:se )?(?:contempla|habra|otorga|aplica|pacta|pagara|paga|entrega|reconoce)(?:n)? anticipo\b|\bsin anticipo\b|\banticipo[:\s]+(?:0\b|cero|no aplica)/;
...
module.exports = { generarDictamenPorReglas, detectar, DETECTORES, REGLAS_VERSION, MOTOR, DATO_COMPARADO };
