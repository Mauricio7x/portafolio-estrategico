/* ============================================================================
   ...
   DOS COSAS, y conviene no confundirlas:
     ...
     TIPOLOGIAS  el catálogo CERRADO de 22 tipos de obra de
                 docs/APU_Y_RENTABILIDAD.md §1.D.1, con sus términos ancla.
...
/* Código INV que se EMITIRÍA al confirmar el artículo contra el índice oficial.
   No se guarda en el catálogo ni se devuelve como `codigo_item`: mientras el
   artículo sea una hipótesis, publicarlo sería publicar una clave inventada. */
function codigoInviasPropuesto(item) {
  ...
  return { codigo: `INV-${item.articulo_invias_candidato}-${variante}`, verificado: false };
}
