...
function senalSecop(l) {
  ...
  if (FASE_ANTES_MANIFESTACION_RE.test(fase)) {
    /* LA FASE ANTERIOR REZAGADA, DESMENTIDA POR UN PUBLICADO (22-sep-2026): si SECOP II ya dio la
       ...
       esa apertura publicada (`aperturaDe`). */
...
/* LA APERTURA PUBLICADA GANA A LA SUPUESTA (22-sep-2026, noche). `fecha_de_publicacion` es
   «Fecha de Publicación (Manifestación de Interés)» en p6dx-8zbt: solo viene cuando SECOP II ya
   publicó esa fase (medido en dos filas enteras pegadas por el dueño: la que recibe avisos la
   trae igual a su publicación; la que sigue en observaciones no la trae). Cuando viene, ES la
   apertura del plazo. `fecha_de_publicacion_del` es la del PROCESO, que con borrador es la del
