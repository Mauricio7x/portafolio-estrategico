...
function festivos(anio) {
  const y = Number(anio);
  if (!Number.isInteger(y) || y < 1984 || y > 2200) throw new Error(`festivos: año fuera de rango (${anio})`);
...
module.exports = { pascua, festivos, esFestivo, esHabil, sumarHabiles, habilesEntre, hoyColombia, festivosConCache, fechaLegible, sumarDias, NOMBRES };
