/* ============================================================================
   ...
   cinco regiones cotizadas cubren 15 departamentos; los otros 18 salen
...
/* `require` de JSON es estático: Vercel lo traza y lo empaqueta con la función
   (`includeFiles: "data/**"`). Si faltara, se degrada a vacío en vez de tumbar
   la consulta — igual que la semilla de vocabulario. */
