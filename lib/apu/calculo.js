...
function calcularItem(entrada, cat, regionId, preciosUsuario = null, departamento = null, opcionesCosto = {}) {
  ...
  if (manual !== null && manual > 0) {
    ...
    return {
      ...
      descripcion: descripcionEntrada || (def ? def.descripcion : null) || (apuInvias ? apuInvias.descripcion : null),
      unidad: unidadEntrada || (def ? def.unidad : null) || (apuInvias ? apuInvias.unidad : null),
      capitulo: capituloEntrada || (def ? def.capitulo : null) || (apuInvias ? apuInvias.capitulo : null) || null,
      fuente: null,
      cantidad,
      sin_apu: true,
      ...
      cascada: require("./precios.js").explicarCascada(codigo, {
        preciosUsuario, enCatalogo: !!def, enInvias: !!apuInvias, elegido: origenManual,
      }),
      referencia_tienda: referenciaTiendaDirecta(),
      // la referencia que la diferencia deja ver: el catálogo, o el APU oficial INVIAS del departamento
      cd_catalogo: cdCat && !cdCat.error ? cdCat.total : (apuInvias ? unitarioInvias(apuInvias) : null),
