...
function calcularItem(entrada, cat, regionId, preciosUsuario = null, departamento = null) {
...
function calcularPresupuesto({ items = [], departamento = "", config = {}, catalogo = null, preciosUsuario = null } = {}) {
  ...
  const calculados = lista.map((it) => calcularItem(it || {}, cat, regionUsada, preciosUsuario, departamento));
