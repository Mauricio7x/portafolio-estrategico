...
function validarPresupuesto({
  ...
  return {
    hallazgos,
    /* «Atención:» y no ⚠️ — un emoji lo dibuja el sistema operativo y estos
       mensajes se pintan en la interfaz vía `alertas` (27-ago-2026). */
    mensajes: hallazgos.map((h) => `${h.severidad === "atencion" ? "Atención —" : "•"} ${h.titulo}: ${h.mensaje}`),
    resumen: {
