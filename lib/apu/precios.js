...
function cotizarItem(item, { cat, regionId, preciosUsuario = null, opcionesCosto = {} } = {}) {
...
/* ═══════════════════════ cotizar una LISTA ════════════════════════════════ */
function cotizar({ items = [], catalogo = null, region = null, preciosUsuario = null, opcionesCosto = {} } = {}) {
  ...
  const lista = (Array.isArray(items) ? items : []).map((it) => cotizarItem(it || {}, {
    cat, regionId, preciosUsuario, opcionesCosto,
  }));
