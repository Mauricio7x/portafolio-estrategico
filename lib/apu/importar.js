 ...
 */
function mapearFilasImportadas(filas, catalogo) {
  ...
  const salida = (filas || []).map((cruda, i) => {
    ...
    const terminos = singularizar(terminosItem(descripcion));
...
module.exports = { mapearFilasImportadas, unidadCanonica, UNIDAD_EQUIV };
