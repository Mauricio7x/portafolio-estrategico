  ...
  return {
    ...
    como_leerlo: aplicadoPct == null
      ...
      : `El catálogo aplica ${aplicadoPct} %. La suma nominal de las tasas de ley da ${sumaNominal} %; `
        ...
        + "y NO es la suma de ninguna combinación exacta: es un valor de referencia de mercado, redondo, dentro del "
        + "rango 1,45–1,60 que se reporta habitualmente. No se ajustó ningún componente para hacerlo cuadrar. "
        + "Liquide el suyo con su nómina real antes de presentar oferta.",
  };
}
