...
function guiaDe({ fila = null, foto = null, perfil, ctx = {} } = {}) {
  ...
  if (cierre && !cerrado) {
    ...
    const observacionesCerradas = !!(manif && manif.secop_observaciones_cerradas) || require("./filtros.js").evaluacionDeFaseAnterior(fila.estado_del_procedimiento, fila.fase);
