...
const VERSION = 2;                      // 2: los documentos del proceso (3-sep-2026)
...
function guiaDe({ fila = null, foto = null, perfil, ctx = {} } = {}) {
  ...
  const obra = {
    ...
    pago: {
      ...
      anticipo_legible: hAnt
        ? (hAnt.anticipo === "no" ? "El pliego dice que no hay anticipo" : anticipo > 0 ? `Anticipo del ${anticipo} % (el pliego lo contempla)` : "Hay anticipo: confirme el porcentaje en el pliego")
  ...
  else if (hAnt) consejo("anticipo", "Hay anticipo, pero confirme el porcentaje y cómo se descuenta",
  ...
  return {
    ...
    obra, requisitos: req, pasos, consejos, dinero, documentos, lo_que_dicen: dicen.hechos,
    resumen: {
