...
const VERSION = 3;                      // 3: «lo que exige este pliego» (4-sep-2026) · 2: los documentos del proceso (3-sep-2026)
...
function guiaDe({ fila = null, foto = null, perfil, ctx = {} } = {}) {
  ...
  return {
    ...
    obra, exigencias, requisitos: req, pasos, consejos, dinero, documentos, lo_que_dicen: dicen.hechos,
    resumen: {
