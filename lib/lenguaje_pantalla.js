...
/* EXCEPCIONES DECLARADAS, con su motivo (censo, no lista: quitar una palabra de
   ...
   · sustantivos y adverbios que acaban igual: además, atrás, contraste, demás,
     después, detrás, estrés, interés, jamás, más, país, revés
     («atrás» se añade el 13-sep-2026: la lista traía «detrás» y no a su hermano,
      que es el hueco que una lista siempre deja; «quedó atrás» es registro de
      usted y no tiene nada que ver con el voseo)
...
const EXCEPCIONES_TUTEO = Object.freeze([
  "además", "atrás", "contraste", "demás", "después", "detrás", "estrés", "interés", "jamás", "más", "país", "revés",
