...
/* EXCEPCIONES DECLARADAS, con su motivo (censo, no lista: quitar una palabra de
   ...
   · sustantivos y adverbios que acaban igual: además, contraste, demás,
     ...
     «atrás», de la misma familia que «interés» y «detrás»
   ...
   · sustantivos en -aste que no son pretérito de tú: contraste, desgaste
...
const EXCEPCIONES_TUTEO = Object.freeze([
  "además", "arnés", "atrás", "contraste", "demás", "después", "detrás", "estrés", "interés", "jamás", "más", "país", "revés",
  "consiste", "desgaste", "existe", "insiste", "persiste",
  "andrés", "vaupés",
  "tranquilo", "tranquila",
  "alquila",
  "paste",
