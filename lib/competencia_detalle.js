...
const {
  MIN_PROCESOS, oferentesDe, esAdjudicado, medianaHistograma, anioDe,
...
const claveCache = (buscada) => `${CLAVES.detalleCompetencia}v3:${buscada}`;
