...
const CAMPOS = [
  ...
  /* LA APERTURA DE LA MANIFESTACIÓN, PUBLICADA (22-sep-2026, dos filas enteras pegadas por el
     dueño, y medido después sobre 1.948 menores cuantías). Cada columna de fecha describe la
     fase VIGENTE de la fila, no la historia del proceso: `fecha_de_publicacion` («Fecha de
     Publicación (Manifestación de Interés)») viene en el 100 % de las filas cuya fase es la
     manifestación y en el 0 % de las que ya están en ofertas; `fecha_de_publicacion_fase_2` (el
     BORRADOR) en el 100 % de las de observaciones y en ninguna otra; `fecha_de_publicacion_fase_3`
     (pliego definitivo) sin medir: se conserva por si viene. La red de seguridad de
