...
function p2K(lic, perfil) {
  ...
  if (crpVal == null) {
    return {
      ...
      mensaje: "Su capacidad de contratación no se puede calcular todavía: falta la utilidad operacional "
        + "(o el ingreso operacional) de su empresa. Cárguela en «Mi empresa» para verificar este proceso.",
    };
  }
