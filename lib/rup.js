...
function evaluarRup(lic, perfilId, conocimiento) {
  ...
  const objeto = evaluarObjeto(lic, perfil, conocimiento);
...
function rup_valido(lic, perfilId, conocimiento) { return evaluarRup(lic, perfilId, conocimiento).ok; }
