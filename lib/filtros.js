...
function filtrarProcesosVisibles(filas, perfilId, conocimiento = {}, opciones = {}) {
  ...
  for (const l of filas || []) {
    ...
    if (rup.paso) { descartes[DESCARTES_OBJETO[rup.paso] || "fuera_unspsc"]++; continue; }
  ...
  return {
    visibles, veredictos, descartes,
    capacidad: { base: base_capacidad, superan_k, no_superan_k },
    opciones: { soloAbiertas, anticipoMin, incluirTextoDebil: opcionesObjeto.incluirTextoDebil },
  };
}
