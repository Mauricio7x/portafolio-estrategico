...
const { MANIFESTACION_INTERES_RE } = require("./semantica.js");   // una sola definición: la usa también lib/manifestacion
...
function selloReglaIngesta() {
  const regla = JSON.stringify({
    ...
    estados: [ESTADOS_ABIERTOS, ESTADOS_CERRADOS, ESTADOS_CERRADOS_EXACTOS, MANIFESTACION_INTERES_RE.source],
...
module.exports = {
  ...
  ESTADOS_ABIERTOS, ESTADOS_CERRADOS, ESTADOS_CERRADOS_EXACTOS, MANIFESTACION_INTERES_RE, estado_abierto, estado_cerrado,
