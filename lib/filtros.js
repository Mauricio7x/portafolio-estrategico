...
function selloReglaIngesta() {
  const regla = JSON.stringify({
    ...
    estados: [ESTADOS_ABIERTOS, ESTADOS_CERRADOS, MANIFESTACION_INTERES_RE.source],
...
module.exports = {
  ...
  ESTADOS_ABIERTOS, ESTADOS_CERRADOS, MANIFESTACION_INTERES_RE, estado_abierto, estado_cerrado,
