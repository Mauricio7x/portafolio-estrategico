...
function derivarJuntos(helder, genesis, base = {}) {
  ...
  return derivarPlural(integrantes, {
    ...
    /* SIN TOPE FIJO (25-sep-2026, encargo del dueño). Aquí vivía un 11.000
       ...
       medida». Ahora sigue la regla de todos los plurales (`derivarPlural`: la
       suma de los apetitos declarados, sin tope si alguno no lo declara), salvo
       que el archivo de carga fije uno para el consorcio. */
...
function aplicarConfig(config, { version = null, cargado = null } = {}) {
  ...
  const pics = perfiles.pics ? perfilDesdeConfig("pics", perfiles.pics, PICS) : PERFILES.pics;
