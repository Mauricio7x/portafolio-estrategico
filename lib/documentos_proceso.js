...
const VERSION = 3;                         // 3: citas literales por tema (4-sep-2026, noche) · 2: experiencia general y específica como hechos propios
...
function hechosDeTexto(texto, { tipo = "otro" } = {}) {
  ...
  return { version: hechosVersion(), tipo, paginas: contarPaginas(t), caracteres: t.length, detecciones, requisitos_numericos: numericos, hitos, deducciones, anticipo, citas: citasDeTexto(t) };
}
...
module.exports = { VERSION, hechosVersion, TIPOS, TEMAS_CITA, MAX_DOCS_PLAN, MAX_PLIEGOS_PLAN, MAX_BYTES_DOC, claveDocs, claveDoc, clasificarArchivo, deduplicar, planDeLectura, hechosDeTexto, citasDeTexto, resumenLectura, loQueDicen, contarPaginas };
