...
const { manifestacionDeFila, noConstaVencida, esUrgente } = require("./manifestacion.js");
...
function facetas(filas, clasificar) {
  ...
  const f = {
    ...
    /* Manifestación de interés: cuántos procesos de menor cuantía hay.
       ...
       pudo situar la ventana. `vencidas` = consta, por fecha publicada, que el
       plazo pasó: los únicos que la casilla esconde. */
    manifestacion: { total: 0, sin_vencer: 0, abiertas: 0, urgentes: 0, pudo_vencer: 0, vencidas: 0, sin_fecha: 0 },
  };
