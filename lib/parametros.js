...
const DEFAULTS = Object.freeze({
  ...
  smmlv: 1750905,                         // D. 1469/2025, vigente de nuevo desde jul-2026 (el D. 159/2026 transitorio traía el mismo valor; editable)
...
const VERIFICACION = Object.freeze({
  smmlv: { estado: "verificado", fuente: "$1.750.905: Decreto 1469/2025 VIGENTE. El Consejo de Estado (Sección Segunda, ponente Jorge Iván Duque Gutiérrez) revocó en julio de 2026 su auto del 12-feb-2026 que lo suspendía provisionalmente y negó la medida cautelar, así que el Decreto 159 de 2026 (19-feb-2026, transitorio con el mismo valor) queda sin efecto práctico; la nulidad de fondo sigue en trámite. Valor leído en el decreto el 16-ago-2026; la revocatoria se conoce por prensa del 17-jul-2026 (Infobae, El Heraldo, La República) — el auto no se leyó desde aquí y su radicado no se anota. Contrastado 6-sep-2026" },
