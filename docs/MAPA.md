...
· MEMORIA · docs/MEMORIA.md — 255 secciones (12 con marcador de superación; el índice entero, derivado: docs/MEMORIA_INDICE.md). Las 10 más nuevas:
  ...
  L 16841  La carga completa se pide con modo=auto: modo=full la empieza de cero en cada llamada (26-s…
