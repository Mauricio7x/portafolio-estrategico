...
· MEMORIA · docs/MEMORIA.md — 197 secciones (5 con marcador de superación; el índice entero, derivado: docs/MEMORIA_INDICE.md). Las 10 más nuevas:
  ...
  L 13210  El prompt de arranque pasa de mandar leer a dar CRITERIO: qué habilidad sirve según lo que …
  L 13258  La tercera investigación de diseño no pudo descargar nada, y el hallazgo caro no era de pie…
