...
· MEMORIA · docs/MEMORIA.md — 196 secciones (5 con marcador de superación; el índice entero, derivado: docs/MEMORIA_INDICE.md). Las 10 más nuevas:
  ...
  L 13143  El millón de frases que nadie puede leer, y las 2.321 que sí (13-sep-2026)
  L 13234  La piel «el umbral» en la landing: la frase manda y las cifras bajan a un friso (13-sep-202…
