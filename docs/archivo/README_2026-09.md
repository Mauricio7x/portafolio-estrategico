> Archivado el 6-sep-2026: superado por el README breve de la raíz y por `node tests/estado.js` (M-DOC-05, consultoría del 4-sep-2026). Es el README tal como quedó el 6-sep-2026 por la mañana (222 KB escritos entre julio y septiembre de 2026), conservado íntegro porque otros documentos citan sus secciones y porque explica, con la fecha de cada cosa, decisiones que siguen vigentes; lo que afirma del árbol (conteos de acciones, «tres pestañas», la piel v2, `public/apu.js`) describe lo que había en su fecha y el árbol de hoy manda. No se edita; se cita por título de sección.

# Detekta · Oportunidades de licitación SECOP II

> Para: ingeniero · Estado: archivado · Sustituido por: README.md
