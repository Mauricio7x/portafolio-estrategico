...
const { cargarCatalogo, leerMeta, SEMILLA } = require("../../../lib/apu/catalogo.js");
...
module.exports = async function handler(req, res) {
  ...
  return res.status(200).json({
    ...
    nota: r.escrito
      ? "Catálogo APU cargado. Los precios son de REFERENCIA (ver docs/APU_Y_RENTABILIDAD.md): cotice antes de presentar oferta."
      : r.nota,
  });
};
